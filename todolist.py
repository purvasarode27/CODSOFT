...
class ToDoApp:
    def __init__(self, root):
        ...
        self.heading_label = tk.Label(root, text="To-Do List", font=("Helvetica", 16, "bold"), bg="#b0e0e6")
        ...
        self.task_listbox = tk.Listbox(root, width=40, selectmode=tk.SINGLE, bg="#c9f7c5")
